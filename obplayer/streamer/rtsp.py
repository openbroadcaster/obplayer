...
class ObRTSPStreamer(object):
    def __init__(self):
        ...
        factory.set_launch(
            'pulsesrc client-name="AudioOut@ObPlayer" ! audioresample ! audioconvert ! capsfilter caps="audio/x-raw,rate='
            + self.clock_rate
            + ',channels=2" ! queue2 ! rtpL24pay name=pay0 pt=96 max-ptime=1000000'
        )
    ...
    def start_discovery(self):
        ...
        self.discovery_proc = subprocess.Popen(
            ["obplayer/streamer/avahi_publish.py"], close_fds=True
        )
