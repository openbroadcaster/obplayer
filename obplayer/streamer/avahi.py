...
SERVER_INVALID, SERVER_REGISTERING, SERVER_RUNNING, SERVER_COLLISION, SERVER_FAILURE = (
    range(0, 5)
)
...
(
    ...
    DOMAIN_BROWSER_BROWSE_DEFAULT,
    DOMAIN_BROWSER_REGISTER,
    DOMAIN_BROWSER_REGISTER_DEFAULT,
    DOMAIN_BROWSER_BROWSE_LEGACY,
) = range(0, 5)
