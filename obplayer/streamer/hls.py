...
class ObHLSStreamer (ObGstStreamer):
    def __init__(self):
 
        ObGstStreamer.__init__(self, 'hls_' + uuid.uuid4().hex)
    ...
    def make_video_pipe(self, res):
        ...
        self.audiopipe.append(self.encoder)
        # Hard bitrate for now.
        self.audiopipe[-1].set_property('bitrate', 128000)
        ...
        self.hls_sink = Gst.ElementFactory.make("hlssink2", "hlssink2")
        self.hls_sink.set_property('max-files', 5)
        self.hls_sink.set_property('playlist-root', obplayer.Config.setting('hls_output_folder'))
        self.hls_sink.set_property('location', "live.ts")
