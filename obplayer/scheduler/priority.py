...
class ObPriorityBroadcaster:
    def __init__(self):
        self.ctrl = obplayer.Player.create_controller(
            "priority", priority=75, default_play_mode="overlap", allow_overlay=True
        )
    ...
    def check_update(self):
        ...
        if (
            obplayer.RemoteData.priority_broadcasts != False
            and obplayer.Sync.priority_sync_running == False
        ):
                    ...
                    if obplayer.Sync.check_media(broadcast):
                        ...
                        self.ctrl.add_request(
                            ...
                            uri=obplayer.Sync.media_uri(
                                broadcast["file_location"], broadcast["filename"]
                            ),
                        ...
                        obplayer.RemoteData.priority_broadcasts[bindex]["next_play"] = (
                            play_time + broadcast["duration"] + broadcast["frequency"]
                        )
                        obplayer.RemoteData.priority_broadcasts[bindex][
                            "last_play"
                        ] = play_time
