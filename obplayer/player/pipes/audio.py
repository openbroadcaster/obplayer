...
class ObAudioPipeline (ObGstPipeline):
    ...
    def set_request(self, req):
        ...
        if req['uri']:
            ...
            self.pipeline = Gst.parse_launch('filesrc name=filesrc ! decodebin ! audioconvert ! audioresample ! capsfilter caps=audio/x-raw,format=S16LE,rate=44100,layout=interleaved,channels=2 ! interpipesink sync=true name=' + self.interpipe_name)
